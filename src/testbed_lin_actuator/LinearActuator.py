...
class LinearActuator:
    def __init__(self, port):
        ...
        self.minimum_joint_positions = [0.0037, 0.0015, 0.0017, 0.0016]
        self.maximum_joint_positions = [0.009, 0.0089, 0.0088, 0.0084]
    ...
    def move_joint_position(self, desired_joint_positions, durations):
        ...
        desired_joint_positions = np.clip(desired_joint_positions,self.minimum_joint_positions,self.maximum_joint_positions)
        if len(desired_joint_positions.shape) == 1:
            combined_array = np.hstack((np.array(durations).reshape(-1,1),np.array(desired_joint_positions).reshape(1,-1)))
        else:
